...
export function ConfigPage() {
  ...
  const usageServiceBase = normalizeUsageServiceBase(
    config?.externalUsageService?.serviceBase ?? ''
  );
  const usageServiceEnabled = Boolean(config?.externalUsageService?.configured && usageServiceBase);
